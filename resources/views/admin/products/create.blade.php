    ...
    <div class="row">
          ...
          <div class="col-6">
              ...
              <div class="form-group mt-2">
                ...
                {!! Form::text('small_description',old('small_descriptio'),['class'=>'form-control']) !!}
              </div>
              <div class="form-group mt-2">
                {!! Form::label('uploadfiles', 'Upload Iamge*') !!}
              </div>
      ...
      <div class="col-6">
              ...
              <div class="form-group mt-2">
                ...
                {!! Form::select('category_id',App\Models\Categories::pluck('name','id'),null, ['class'=>'form-control','id'=>'SelectorCategory','placeholder'=>'Select Category']) !!}

              </div>
              <div id ="SelectorSubCategory"class="form-group mt-2">
                {!! Form::label('subcategory_id', 'SubCategory*') !!}
                {!! Form::select('subcategory_id',[],null, ['class'=>'form-control','id'=>'subcategory_id','placeholder'=>'Select Category']) !!}
              </div>
