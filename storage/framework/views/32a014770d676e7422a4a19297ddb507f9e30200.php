...
?> 
<div class="col-12 mb-1  px-0 pb-0 noselect notifications-notifications " style="border-bottom: 1px solid var(--bg-main-bg);background:<?php echo e($bg); ?>">
        ...
        <div class="text-center" style="max-width: 63px;padding: 4px 9px 4px 9px!important;">
            <div style="display:flex;">
                <div style="width: 45px;background: var(--bg-second-bg);display: inline-block;border-radius: 5%!important;border: 1px solid  var(--bg-main-bg);max-width: 100%;position: relative;height: 45px;overflow: hidden;" class="mx-auto notification-image mt-2">
                    <img 
                    <?php if(isset($notification['image']) && $notification['image']!=null): ?>
                    src="<?php echo e($notification['image']); ?>"
                    <?php else: ?>
                    src="<?php echo e(env('DEFAULT_IMAGE_NOTIFICATION')); ?>" 
                    <?php endif; ?>
            ...
            <div>
                ...
                <div style=" display: inline-block;position: relative;font-size: 14px;color: #919191">
                    <div class="col-12  px-0  text-right text-md-right " style="color: #919191;font-size: 13px;padding: 1px 0px">
                        ...
                        <span class="naskh font-small"><?php echo e(\Carbon::parse($notification['created_at'])->diffForHumans()); ?></span>
                    </div>
                </div>
            </div>
        </div>
...
<?php endif; ?>
<?php endif; ?>
<?php /**PATH /opt/lampp/htdocs/laravel/dashboard/resources/views/components/notifications.blade.php ENDPATH**/ ?>