      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php echo Form::open(['url'=>route('admin.categories.subcategory.update',$Subcategories->id),'method'=>'PUT', 'files' => true]); ?>
            ...
            <div class="form-group mt-2">
                ...
                <?php echo Form::hidden('avatar', $Subcategories->subCategoryImage(), ['id'=>'encoded_image']); ?>
