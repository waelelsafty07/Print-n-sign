...
<div class="modal fade" id="exampleModal<?php echo e($model->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo Form::open(['url'=>route('admin.products.destroy',$id),'method'=>'DELETE']); ?>

      <div class="modal-body">

        <div class="alert alert-danger">
            Delete <?php echo e($products_name); ?>
...
<?php /**PATH /opt/lampp/htdocs/laravel/dashboard/resources/views/admin/products/btn/delete.blade.php ENDPATH**/ ?>