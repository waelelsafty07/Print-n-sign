    ...
    <div class="row">
      <div class="col-12">
        <div class="card">
          ...
          <?php echo Form::open(['id'=>'form_data','url'=>route('admin.categories.subcategory.multiple'),'method'=>'delete']); ?>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/laravel/dashboard/resources/views/admin/categories/subcategories/index.blade.php ENDPATH**/ ?>