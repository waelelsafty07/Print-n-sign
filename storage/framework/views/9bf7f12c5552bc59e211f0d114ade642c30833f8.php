      ...
      <div class="col-12">
        <div class="card">
          ...
          <div class="card-body">
            ...
            <?php echo Form::open(['url'=>route('admin.categories.update',$category->id),'method'=>'PUT', 'files' => true]); ?>
            ...
            <div class="form-group mt-2">
                ...
                <?php echo Form::hidden('avatar', $category->CategoryImage(), ['id'=>'encoded_image']); ?>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.admin', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/lampp/htdocs/laravel/dashboard/resources/views/admin/categories/edit.blade.php ENDPATH**/ ?>