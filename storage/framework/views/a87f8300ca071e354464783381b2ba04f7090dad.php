...
<div class="u-s-p-b-60">
                            ...
                            <div class="col-lg-4 col-md-6 u-s-m-b-30">
                                <div class="contact-o u-h-100">
                                    <div class="contact-o__wrap">
                                        ...
                                        <span class="contact-o__info-text-2"><?php echo e($settings->phone); ?></span>

                                        <span class="contact-o__info-text-2"><?php echo e($settings->phone2); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-lg-4 col-md-6 u-s-m-b-30">
                                <div class="contact-o u-h-100">
                                    <div class="contact-o__wrap">
                                        ...
                                        <span class="contact-o__info-text-2"><?php echo e($settings->address); ?></span>
                ...
                <!--====== End - Section Content ======-->
            </div><?php /**PATH /opt/lampp/htdocs/laravel/dashboard/resources/views/front/map/index.blade.php ENDPATH**/ ?>