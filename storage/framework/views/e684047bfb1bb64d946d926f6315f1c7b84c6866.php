...
<div class="modal fade" id="exampleModal<?php echo e($model->id); ?>" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <?php echo Form::open(['url'=>route('admin.categories.subcategory.destroy',$id),'method'=>'DELETE']); ?>
...
<?php /**PATH /opt/lampp/htdocs/laravel/dashboard/resources/views/admin/categories/subcategories/btn/delete.blade.php ENDPATH**/ ?>