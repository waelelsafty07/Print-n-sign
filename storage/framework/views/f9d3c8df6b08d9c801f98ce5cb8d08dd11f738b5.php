...
} elseif ($_instance->childHasBeenRendered('IeRMzjq')) {
    $componentId = $_instance->getRenderedChildComponentId('IeRMzjq');
    $componentTag = $_instance->getRenderedChildComponentTagName('IeRMzjq');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IeRMzjq');
} else {
    $response = \Livewire\Livewire::mount('dashboard-statistics', []);
    $html = $response->html();
    $_instance->logRenderedChild('IeRMzjq', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
